            ...
            <div class="row justify-content-center g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <label class="w-100">
                        ...
                        <div
                            class="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0 cursor-pointer">
                            ...
                            <span class="btn btn-square position-absolute top-0 end-0 m-3"><i
                                    class="fa fa-mars text-primary"></i></span>
                        </div>
                    </label>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                    <label class="w-100">
                        ...
                        <div
                            ...
                            <span class="btn btn-square position-absolute top-0 end-0 m-3"><i
                                    class="fa fa-venus text-primary"></i></span>
                        </div>
                    </label>
                </div>
            </div>
