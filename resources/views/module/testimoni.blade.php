    ...
    @push('scripts')
        <script>
            ...
            let testimonials = [{
                    name: 'Rizky Maulana',
                    rating: 4,
                    comment: 'Pelayanan ramah dan hasil potongannya sangat rapi.'
                },
                {
                    name: 'Sarah Amanda',
                    rating: 5,
                    comment: 'Barberman-nya profesional, tempatnya juga nyaman.'
                },
                {
                    name: 'Andi Pratama',
                    rating: 3,
                    comment: 'Cukup memuaskan, perlu lebih cepat prosesnya.'
                }
            ];
